    ...
    <Layout>
      <div className="dist-page basetext-inter">
        <div className="dist-header">
          <div>
            <h1 className="destaque-archivo-black">Registrar Distribuição</h1>
            <p>Associe itens a um beneficiário</p>
          </div>
        </div>
        ...
        <section className="endpoint-card">
          ...
          <div className="actions-row end">
            <button
              ...
              onClick={submit}
              disabled={submitting || itens.length === 0 || !beneficiarioId}
            >
              {submitting ? "Enviando..." : "Registrar distribuição"}
            </button>
          </div>
        </section>
      </div>
